         ...
         <div class="container">
            <div class="row">
                  ...
                  <div class="profile_info">
                     <div class="seller-card">
                        ...
                        <div class="user-profile-info">
                           ...
                           <div class="user-profile-label">
                              <div class="username-line">
                                 <a href="#" class="seller-link">{{$user->name}}</a>
                              </div>
                              <div class="oneliner-wrapper">
                                 <small class="oneliner">{{$user->Freelancer->title}}</small>
                                 <div class="ratings-wrapper">
                                    <p class="rating-text"><strong>{{$user->rating}}</strong> ({{$user->total_reviews}} reviews)</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="user-stats-desc">
                           <ul class="user-stats">
                              <li class="location">From<strong>{{$user->country_name}}</strong></li>
                              <li class="member-since">Member since<strong>{{$user->created_at}}</strong></li>
               ...
               <div class="col-lg-8 right">
                  <h2>{{$user->name}}'s Gigs</h2>
                  <div class="recommended">
                     <div class="row">
                         @forelse ($user->Freelancer->UserServices as $gig)
                         <div class="col-md-4">
                            <div>
                               <a href="#">
                               <img class="img-fluid" src="{{asset($gig->ServiceMedia[0]->media)}}" />
                               </a>
                  ...
                  <div class="review-section">
                     <div class="d-flex align-items-center justify-content-between mb-4">
                        <h4 class="m-0">Reviews as Seller <small><span class="star-rating-s15"></span><span><span
                           ...
                           data-impression-collected="true">{{$user->rating}}</span></span><span><span
                           class="total-rating header-total-rating"
                           data-impression-collected="true">({{$user->total_reviews}})</span></span></small> </h4>
