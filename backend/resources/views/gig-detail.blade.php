               ...
               <div class="col-lg-8 left">
                  ...
                  <div id="overview" class="seller-overview d-flex align-items-center">
                        <div class="user-profile-image d-flex">
                            <label class="profile-pict" for="profile_image">
                                <img
                                src="{{asset($service->UserService->user->image)}}"
                                class="profile-pict-img img-fluid" alt="">
                            </label>
                            <div class="profile-name">
                                <span class="user-status">
                                    <a href="#" class="seller-link">{{$service->UserService->user->name}}</a>
                                </span>
                     ...
                     <div class="user-info d-flex">
                        <span class="user-info-rating d-flex">
                           ...
                           <span class="total-rating-out-five">{{$service->UserService->user->rating}}</span>
                           <span class="total-rating">({{$service->UserService->user->total_reviews}})</span>
                        </span>
                  ...
                  <div class="slider mt-4">
                     <div id="aniimated-thumbnials" class="slider-for slick-slider-single">
                         <a href="#">
                            <img class="img-fluid" src="{{asset($service->ServiceMedia[0]->media)}}" />
                        </a>
                     </div>
                    <div class="slider-nav slick-slider-single">
                        @foreach ($service->ServiceMedia as $thumbnail)
                            <div class="item-slick">
                                <img class="img-fluid" src="{{asset($thumbnail->media)}}"
                                    alt="Alt">
                            </div>
                        @endforeach
                    </div>
                  ...
                  <div class="profile-card">
                     <div class="user-profile-image d-flex">
                        ...
                        <img
                           src="{{asset($service->UserService->user->image)}}"
                           class="profile-pict-img img-fluid" alt="avator">
                        </label>
                        <div class="right">
                           <div class="profile-name">
                              <span class="user-status">
                              ...
                              <div class="seller-level">{{$service->UserService->freelancer_title}}</div>
                           </div>
                           <div class="user-info">
                              <span class="user-info-rating d-flex align-items-center">
                                 ...
                                 <span class="total-rating-out-five">{{$service->rating}}</span>
                     ...
                     <div class="stats-desc">
                        <ul class="user-stats">
                           ...
                           <li>Member since<strong>{{$service->UserService->created_at}}</strong></li>
                  ...
                  <div id="reviews" class="review-section">
                     <div class="d-flex align-items-center justify-content-between mb-4">
                        <h4 class="m-0"> {{$service->reviews->count()}} Reviews </h4>
