    ...
    <div class="container-fluid">
        ...
        <a href="/" class="topnav-logo">
            <span class="topnav-logo-lg d-flex align-items-center">
                <img src="{{ asset('assets/images/Pro-eLean-.png') }}" alt="" height="40">
                <span style="font-size:1.4rem;  font-weight:600" class="ms-2">Proelean</span>
            </span>
            <span class="topnav-logo-sm">
                <img src="{{ asset('assets/admin/logo/proelean.png') }}" alt="" height="16">
        ...
        <ul class="list-unstyled topbar-menu float-end mb-0">
            ...
            {{-- <li class="dropdown notification-list topbar-dropdown d-none d-lg-block">
                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" id="topbar-languagedrop"
                    ...
                    <img src="assets/admin/images/flags/us.jpg" alt="user-image" class="me-1" height="12">
                    ...
                    <div style="max-height: 230px;" data-simplebar>
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="notify-icon">
                                <img src="assets/admin/images/users/avatar-2.jpg" class="img-fluid rounded-circle"
                                    alt="" />
                            </div>
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="notify-icon">
                                <img src="assets/admin/images/users/avatar-4.jpg" class="img-fluid rounded-circle"
                                    alt="" />
                            </div>
        ...
        <div class="app-search dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                ...
                <div class="notification-list">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <div class="d-flex">
                            <img class="d-flex me-2 rounded-circle" src="assets/admin/images/users/avatar-2.jpg"
