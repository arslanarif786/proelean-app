            ...
            <div class="row">
               ...
               <div class="col-lg-9 view_slider recommended">
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="sorting-div d-flex align-items-center justify-content-between">
                           <p class="mb-2">{{$gigs[0]->available_services}} Services available</p>
                  ...
                  <div class="row">
                      ...
                      @forelse ($gigs as $service)
                        <div class="col-md-4">
                            <a href="/seller/gigs/{{$service->uuid}}">
                            <img class="img-fluid" src="{{asset($service->banner)}}" />
                            </a>
                            ...
                            <div class="inner-wrapper">
                                <div class="d-flex align-items-center">
                                    ...
                                    <img class="img-fluid"
                                        src="{{asset($service->user_image)}}"
                                        alt='' />
                                    </span>
                                    <span class="seller-name">
                                    <a href="#">{{$service->user_name}}</a>
                        ...
                        <ul class="pagination mb-0">
                           ...
                           <li class="page-item">
                              <a class="page-link" href="#" aria-label="Next">
                               ...
                               <li class="page-item">{{$gigs->links()}}</li>
