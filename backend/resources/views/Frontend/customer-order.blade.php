      ...
      <section class="py-5">
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-9">
                  <h4 class="font-weight-bold pb-3">What Service Are You Looking For?</h4>
                  <div class="bg-white rounded shadow-sm sidebar-page-right">
                     <div class="bg-white rounded p-0">
                        <div class="border-bottom p-3">
                           ...
                           <form>
                              <div class="form-group">
                                 <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" placeholder="I'm looking for..."></textarea>
                              </div>
                              <div class="form-group">
                                 <label for="exampleFormControlFile1" class="font-weight-bold">Attach Files</label>
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-6">
                                 <select id="inputState1" class="form-control">
                                    ...
                                    <option>Graphics for Streamers</option>
                        ...
                        <div class="border-bottom p-3">
                           ...
                           <div class="btn-group btn-group-toggle col-md-12 p-0" data-toggle="buttons">
                              <label class="btn btn-outline-success btn-sm active">
                              <input type="radio" name="options" id="option1" checked> 24 Hours
                              </label>
                              <label class="btn btn-outline-success btn-sm">
                              <input type="radio" name="options" id="option2"> 3 Days
                              </label>
                              <label class="btn btn-outline-success btn-sm">
                              <input type="radio" name="options" id="option3"> 7 Days
                              </label>
                              <label class="btn btn-outline-success btn-sm">
                              <input type="radio" name="options" id="option4"> <i class="fa fa-pencil" aria-hidden="true"></i> Others
                              </label>
                           </div>
                        </div>
                        <div class="border-bottom p-3">
                        ...
                        <div class="p-3 d-flex justify-content-end">
                           <a href="#" class="btn btn-success btn-lg font-weight-bold">Submit Request</a>
                        </div>
                     </div>
                  </div>
               </div>
