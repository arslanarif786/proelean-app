               ...
               <div class="col-lg-3">
                  <div class="bg-white rounded shadow-sm py-3 sidebar-fix">
                     <div class="dropdown-menu-show">
                        ...
                        <a class="dropdown-item py-2 active" href="edit-notifications.html">Edit Notification</a>
               ...
               <div class="col-lg-9">
                  <div class="bg-white rounded shadow-sm sidebar-page-right">
                     <div>
                        <div class="p-3 border-bottom">
                           <form>
                              <div class="row form-group">
                                 <div class="col-md-4">
                                    <p class="text-muted font-weight-bold h6 mb-3">NOTIFICATIONS</p>
                                    <p class="text-muted mb-0">For important updates regarding your Miver activity, certain notifications cannot be disabled.</p>
                                 </div>
                                 <div class="col-md-4">
                                    <p class="text-muted font-weight-bold h6 mb-3">TYPE</p>
                                    <p class="text-muted font-weight-bold">Inbox Messages</p>
                                    <p class="text-muted font-weight-bold">Order Messages</p>
                                    <p class="text-muted font-weight-bold">Order Updates</p>
                                 </div>
                                 <div class="col-md-4">
                                    <p class="text-muted font-weight-bold h6 mb-3">Email</p>
                        ...
                        <div class="p-3">
                           <form>
                              <p class="text-muted font-weight-bold mb-0">REAL-TIME NOTIFICATIONS <span data-toggle="tooltip" data-placement="right" title="This includes inbox messages, order updates, account updates, etc."><i class="fa fa-question-circle" aria-hidden="true"></i></span></p>
                              <div class="row pt-3">
                                 <div class="col-md-4">
                                    <p class="text-muted font-weight-bold">Enable/disable real-time notifications</p>
                                    <p class="text-muted font-weight-bold">Enable/disable sound</p>
                                 </div>
                                 <div class="col-md-4">
                                    <p>
                                    <div class="custom-control custom-switch">
                                       <input type="checkbox" class="custom-control-input" id="customSwitch1">
                                       <label class="custom-control-label" for="customSwitch1"><a href="#" class="text-success">Try Me!</a></label>
                                    </div>
                                    </p>
                                    <p>
                                    <div class="custom-control custom-switch">
                                       <input type="checkbox" class="custom-control-input" id="customSwitch2" checked>
                                       <label class="custom-control-label" for="customSwitch2"><i class="fa fa-volume-up" aria-hidden="true"></i></label>
                                    </div>
                                    </p>
                                 </div>
                              </div>
