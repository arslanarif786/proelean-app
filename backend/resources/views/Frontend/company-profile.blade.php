            ...
            <div class="row">
               ...
               <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
                  ...
                  <div class="box mb-3 shadow-sm rounded bg-white osahan-post">
                     ...
                     <img src="images/post1.png" class="img-fluid" alt="Responsive image">
               ...
               <aside class="col col-xl-3 order-xl-3 col-lg-6 order-lg-3 col-md-6 col-sm-6 col-12">
                     ...
                     <div class="box-body p-3">
                           ...
                           <div class="shadow-sm rounded bg-white job-item mb-3">
                              ...
                              <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                 <div class="overlap-rounded-circle">
                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="images/user/s4.png" alt="" data-original-title="Sophia Lee">
                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="images/user/s5.png" alt="" data-original-title="John Doe">
                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="images/user/s6.png" alt="" data-original-title="Julia Cox">
                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="images/user/s7.png" alt="" data-original-title="Robert Cook">
                                 </div>
                        ...
                        <a href="job-profile.html">
                           <div class="shadow-sm rounded bg-white job-item">
                              ...
                              <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                 <div class="overlap-rounded-circle">
                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="images/user/s8.png" alt="" data-original-title="Sophia Lee">
                                    <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="images/user/s9.png" alt="" data-original-title="John Doe">
                  ...
                  <div class="box shadow-sm rounded bg-white mb-3">
                     ...
                     <div class="box-body p-3">
                        ...
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                           <div class="dropdown-list-image mr-3">
                              <img class="rounded-circle" src="images/user/s6.png" alt="">
                              <div class="status-indicator bg-success"></div>
                           </div>
                           <div class="font-weight-bold mr-2">
