...
<a class="dropdown-item" href="messages.html">Messages</a>
            ...
            <div class="row py-lg-5">
               <div class="col-lg-8 mx-auto">
                  <div class="homepage-search-title">
                     ...
                     <h5 class="mb-5 text-shadow text-white-50 font-weight-normal">Millions of people use miver to turn their ideas into reality.
                     </h5>
                  </div>
      ...
      <div class="market-wrapper py-5 bg-white">
         <div class="container">
            <h2 class="text-center">Explore the marketplaces</h2>
