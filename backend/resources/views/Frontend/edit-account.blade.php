               ...
               <div class="col-lg-3">
                  <div class="bg-white rounded shadow-sm py-3 sidebar-fix">
                     <div class="dropdown-menu-show">
                        ...
                        <a class="dropdown-item py-2 active" href="edit-account.html">Edit Account</a>
                  ...
                  <div class="bg-white rounded shadow-sm sidebar-page-right">
                     <div>
                        <div class="p-3 border-bottom text-right">
                           <h6 class="mb-0">Need to update your profile? <a href="account.html" class="text-success">Go to My Profile</a>
                           </h6>
                        </div>
                        <div class="p-3 border-bottom">
                           <form>
                              <div class="row d-flex align-items-center form-group">
                                 <div class="col-md-4">
                                    <p class="text-muted font-weight-bold mb-0">FULL NAME</p>
                                 </div>
                                 <div class="col-md-8">
                                    <input type="text" name="name" class="form-control font-weight-bold text-muted" value="Gurdeep Singh">
                                 </div>
                              </div>
                              <div class="row d-flex align-items-center form-group">
                                 <div class="col-md-4">
                                 ...
                                 <div class="col-md-8">
                                    <input type="email" name="email" class="form-control font-weight-bold text-muted" value="g**************4@gmail.com">
                                 </div>
                              </div>
                              <div class="row d-flex align-items-center form-group">
                                 <div class="col-md-4">
                                    <p class="text-muted font-weight-bold mb-0">ONLINE STATUS <span class="ml-2 small"><i class="fa fa-circle text-success" aria-hidden="true"></i></span></p>
                                    <p class="text-muted">When online, your Gigs are visible under the Online search filter.</p>
                                 </div>
                                 <div class="col-md-8">
                        ...
                        <div class="p-3">
                           <form>
                              <div class="row form-group">
                                 <div class="col-md-4">
                                    <p class="text-muted font-weight-bold mb-0">ACCOUNT DEACTIVATION</p>
                                 </div>
                                 <div class="col-md-8">
                                    <p class="text-muted">What happens when you deactivate your account?</p>
                                    <dl class="text-muted">
                                       <li>Your profile and Gigs won't be shown on Miver anymore. <span data-toggle="tooltip" data-placement="top" title="People who will try to view your profile or Gigs will get an 'Unavailable Page' message."><i class="fa fa-question-circle" aria-hidden="true"></i></span></li>
                                       <li>Active orders will be cancelled.  <span data-toggle="tooltip" data-placement="top" title="Not including delivered orders."><i class="fa fa-question-circle" aria-hidden="true"></i></li>
                              ...
                              <div class="row d-flex align-items-center form-group">
                                 <div class="col-md-4">
                                    <p class="text-muted font-weight-bold mb-0">I'm leaving because...</p>
                                 </div>
                                 <div class="col-md-8">
                                    <select class="form-control">
                                       <option>Choose a reason</option>
                                       <optgroup label="Account" issues="">
                                          <option>Unsubscribe from Miver emails</option>
                                          <option>I want to change my username</option>
                                          <option>I have another Miver account</option>
                                          <option>Other</option>
                                       </optgroup>
                                       <optgroup label="Buying" issues="">
                                          <option>I can't find what I need on Miver</option>
                                          <option>Miver is complicated or hard to use</option>
                                          <option>Negative experience with seller/s</option>
                                          <option>I'm unhappy with Miver's policies</option>
                                          <option>Other</option>
                                       </optgroup>
                                    </select>
                                 </div>
                              ...
                              <div class="row form-group">
                                 <div class="col-md-4">
                                    <p class="text-muted font-weight-bold mb-0">Tell us more (optional)</p>
                                 </div>
                                 <div class="col-md-8">
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" placeholder="Help us become better..."></textarea>
                                 </div>
                              </div>
                              <div class="text-right">
