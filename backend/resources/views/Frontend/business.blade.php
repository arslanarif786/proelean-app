      ...
      <section class="py-5">
         <div class="container">
            <div class="text-center">
               <h1 class="font-weight-bold">Hi Gurdeep,</h1>
               <h3 class="font-weight-bold">how do you prefer handling your existing account?</h3>
               <h5 class="text-muted">You’re signed in as iamosahan@gmail.com</h5>
            </div>
            <div class="row pt-5 d-flex justify-content-center">
               <div class="col-md-5">
                  <div class="bg-white rounded shadow-sm p-5">
                     ...
                     <p class="h5 font-weight-bold text-center">Keep my personal account separate from my work activity</p>
                     <p class="text-muted text-center">Manage 2 accounts with 2 separate logins, one for my private stuff and one for work</p>
                     <a href="#" class="btn btn-success btn-lg btn-block my-3">Continue</a>
                     <p class="text-center text-muted pt-2">Your account won’t be converted yet</p>
                  </div>
               </div>
               ...
               <div class="col-md-5">
                  <div class="bg-white rounded shadow-sm p-5">
                     ...
                     <p class="h5 font-weight-bold text-center">Convert my existing account to miver Business</p>
                     <p class="text-muted text-center">Move my personal activity into a collaborative account and share it with my team</p>
                     <a href="#" class="btn btn-outline-success btn-lg btn-block my-3">Learn More</a>
                     <p class="text-center text-muted pt-2">Your account won’t be converted yet</p>
                  </div>
               </div>
            </div>
