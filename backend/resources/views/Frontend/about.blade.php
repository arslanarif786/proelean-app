         ...
         <div class="container">
            <div class="row align-items-center">
               <div class=" col-lg-6 col-md-6 ">
                  <img class="rounded img-fluid" src="{{asset('assets/images/Pro-eLean-business.jpg')}}" alt="Card image cap">
               </div>
               <div class="col-lg-6 col-md-6  ">
      ...
      <!-- End About 1-->
         ...
         <div class="container">
            <div class="row align-items-center">
               ...
               <div class=" col-lg-6 col-md-6 ">
                  <img class="rounded img-fluid" src="{{asset('assets/images/Pro-eLean--freelancer business.jpg')}}" alt="Card image cap">
               </div>
            </div>
         </div>
      </section>
            ...
            <div class="row">
               <div class="col-lg-4 col-md-4">
                  <div class="agents-card text-center">
                     <img class="img-fluid mb-4" src="{{asset('assets/images/user/s1.png')}}" alt="">
               ...
               <div class="col-lg-4 col-md-4">
                  <div class="agents-card text-center">
                     <img class="img-fluid mb-4" src="{{asset('assets/images/user/s2.png')}}" alt="">
                     <!-- <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p> -->
               ...
               <div class="col-lg-4 col-md-4">
                  <div class="agents-card text-center">
                     <img class="img-fluid mb-4" src="{{asset('assets/images/user/s3.png')}}" alt="">
                     <!-- <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p> -->
