   ...
   <body>
      ...
      <section class="py-5">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <h4 class="font-weight-bold pb-3">Ready to start selling on miver? Here’s the breakdown:</h4>
                  <div class="d-flex align-items-center py-3 mb-1 bg-white rounded shadow-sm">
                     <div class="col-sm-2">
                        <span class="icon-color display-4"><i class="fa fa-book fa-fw" aria-hidden="true"></i></span>
                     </div>
                     <div class="col-sm-10">
                        <p class="h6 mb-1">Learn what makes a successful profile</p>
                        <p class="text-muted m-0">Discover the do’s and don’ts to ensure you’re always on the right track.</p>
                     </div>
                  </div>
                  <div class="d-flex align-items-center mb-1 bg-white rounded shadow-sm py-3">
                     <div class="col-sm-2">
                        <span class="icon-color display-4"><i class="fa fa-user-circle-o fa-fw" aria-hidden="true"></i></span>
                     </div>
                     <div class="col-sm-10">
                        <p class="h6 mb-1">Create your seller profile</p>
                        <p class="text-muted m-0">Add your profile picture, description, and professional information.</p>
                     </div>
                  </div>
                  <div class="d-flex align-items-center mb-1 bg-white rounded shadow-sm py-3">
                     <div class="col-sm-2">
                        <span class="icon-color display-4"><i class="fa fa-building fa-fw" aria-hidden="true"></i></span>
                     </div>
                     <div class="col-sm-10">
                        <p class="h6 mb-1">Publish your Gig</p>
                        <p class="text-muted m-0">Create a Gig of the service you’re offering and start selling instantly.</p>
                     </div>
                  </div>
                  <div class="button py-3 d-flex justify-content-end">
                     <button class="btn btn-success btn-lg py-2 px-3"><a href="#" class="text-white h6">Continue</a></button>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="embed-responsive embed-responsive-4by3">
                     <iframe width="100%" height="315" src="https://www.youtube.com/embed/ezbJwaLmOeM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>   
                  </div>
               </div>
            </div>
         </div>
