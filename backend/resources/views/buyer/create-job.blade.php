      ...
      <section class="py-5">
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-9">
                  <h4 class="font-weight-bold pb-3">Create Job</h4>
                  <form action="/buyer/jobs" method="POST" enctype="multipart/form-data"> 
                     @csrf
                     ...
                     <div class="bg-white rounded p-0">
                        <div class="border-bottom p-3">
                              ...
                              <div class="form-group">
                                 <textarea class="form-control" name="description" rows="7" placeholder="Describe About Your Serivce" required>{{old('description')}}</textarea>
                              </div>
                              <div class="form-group d-md-flex justify-content-center align-items-center py-4">
                                 <label for="exampleFormControlFile1" class="font-weight-bold pr-2 py-3">Document(optional)</label>
                                 <input type="file" class="form-control-file" name="cinic" id="exampleFormControlFile1">
                              </div>
                        </div>
                        <div class="border-bottom p-3">
                        ...
                        <div class="border-bottom p-3">
                           <label>What is your budget for this job?</label>
                           <div class="input-group mb-2 col-md-4 p-0">
                              <div class="input-group-prepend">
                                 <div class="btn btn-success">$</div>
                              </div>
                              <input type="number" class="form-control" name="budget" id="inlineFormInputGroup" required>
                           </div>
                        </div>
